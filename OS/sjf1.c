...
void if_bt_eq();
void if_at_eq();
int index1 = 0, index, process_limit;
...
// start main function
int main(){
	int flag, flag1=0,temp_process_id,ctime = 0;
	...
	for(index = 1;index<process_limit-1;index++){
		for(index1 =1;index1<(process_limit-1-index);index1++){
				if(array_of_process[index1].burst_time>array_of_process[index1+1].burst_time){
						temp_process = array_of_process[index1];
						array_of_process[index1] = array_of_process[index1+1];
						array_of_process[index1+1] = temp_process;
					}
	...
	/*for(index = 1;index<process_limit-1;index++){
		for(index1 =1;index1<(process_limit-2-index);index1++){
			if(array_of_process[index1].arrival_time == array_of_process[index1+1].arrival_time){
				if(array_of_process[index1].name_of_process>array_of_process[index1+1].name_of_process){
						temp_process = array_of_process[index1];
						array_of_process[index1] = array_of_process[index1+1];
